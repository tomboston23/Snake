...
class Application:
    ...
    def train(self):
        ...
        print(f"The best score during training was {max(self.points_results)}")
    ...
    def test(self):
        ...
        for i, cond in enumerate(init_conds):
            ...
            m = max(max(points_results), m)
        print(f"The best score during testing was {m}")
    ...
    def show_games(self):
        ...
        if len(points_results) == 0:
            return
        print(f"The best score during show was {max(points_results)}")
...
def main():
    ...
    parser.add_argument('--gamma', dest="gamma", type=float, default=0.7,
                        help='the gamma parameter used in learning rate - default 0.7')
